...
class DoctorPatientsListPage extends StatefulWidget {
  const DoctorPatientsListPage({super.key});

  @override
  State<DoctorPatientsListPage> createState() => _DoctorPatientsListPageState();
}

class _DoctorPatientsListPageState extends State<DoctorPatientsListPage> {
