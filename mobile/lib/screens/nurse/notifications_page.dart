...
class NurseNotificationsPage extends StatefulWidget {
  const NurseNotificationsPage({super.key});

  @override
  State<NurseNotificationsPage> createState() => _NurseNotificationsPageState();
}

class _NurseNotificationsPageState extends State<NurseNotificationsPage> {
  List<notif.AppNotification> _notifications = [];
  bool _loading = true;
  String? _error;
  bool _hasLoaded = false;
  String _filter = 'all'; // 'all', 'unread', or 'measurements'
  ...
  List<notif.AppNotification> get _filteredNotifications {
    ...
    if (_filter == 'measurements') {
      return _notifications.where((n) => 
        n.type == NotificationType.reminder && 
        n.relatedEntityType == 'scheduledReading'
      ).toList();
    }
  ...
  void _handleNotificationTap(notif.AppNotification n) {
    ...
    if (n.actionUrl != null && n.actionUrl!.isNotEmpty) {
      Navigator.pushNamed(context, n.actionUrl!);
    } else if (n.relatedEntityType == 'scheduledReading') {
      // Navigate to scheduled readings page
      ...
      child: Row(
        children: [
          ...
          _FilterChip(
            ...
            selected: _filter == 'measurements',
            onTap: () => setState(() => _filter = 'measurements'),
          ),
        ],
      ),
    );
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            const SizedBox(width: 8),
                            if (n.type == NotificationType.reminder && n.relatedEntityType == 'scheduledReading')
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Icon(Icons.access_time, size: 14, color: theme.colorScheme.onPrimaryContainer),
